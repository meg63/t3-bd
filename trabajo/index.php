...
<div class="container mt-5">
    ...
    <h1>Trabajo final BD1 - (Jardín Botánico)</h1>
    ...
    <div class="integrantes">
        <h2>Integrantes</h2>
        <ul>
            <li>Yamid Andrés Campo Gallego</li>
            <li> Maria Alejandra Echavarria Correa</li>
        </ul>
    </div>
    ...
    <div class="modelo">
        <h2>Modelo E-R </h2>
        <p></p>
        <img src="ermodelo.png">
    </div>

    <div class="enlaces">
        <h2>Enlaces</h2>
        <ul>
            <li><a href="patrocinador/patrocinador.php">PATROCINADOR</a></li>
            <li><a href="departamento/departamento.php">DEPARTAMENTO</a></li>
