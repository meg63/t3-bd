...
<div class="formulario p-4 m-3 border rounded-3">
    ...
    <form action="proyecto_insert.php" method="post" class="form-group">
        ...
        <div class="mb-3">
            <label for="fechacreacion" class="form-label">Fecha</label>
        ...
        <div class="mb-3">
            <label for="empresa" class="form-label">Verificador</label>
        ...
        <div class="mb-3">
            <label for="cliente" class="form-label">Receptor</label>
